...
////////////////////////////////////////////////////////////////////////////////
auto constexpr ip_address_primary{"--ip_address"};
auto constexpr ip_address_secondary{"-i"};
auto constexpr ip_address_description{"IP address to bind to."};
...
Arguments parse_arguments(int argc, char** argv)
{
    ...
    return {
        parse_required_argument<std::string>(
            args, ip_address_primary, ip_address_secondary
        ),
        parse_required_argument<int>(args, port_primary, port_secondary)
    };
}
